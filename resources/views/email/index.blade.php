            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="http://example.com" style="text-decoration: none;">
                  <img class="mobile-center" src="../../../images/header/logo.png" width="105" alt="Header Logo" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
          ...
          <table class="row" align="center" bgcolor="#F8F8F8" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; font-weight: 400; text-align: left;">
                <div class="serif" style="color: #1F2225; font-size: 28px; font-weight: 700; line-height: 50px; margin-bottom: 30px;">Hi John Adams,</div>
                <div class="sans-serif" style="color: #969AA1; font-size: 18px; line-height: 28px; margin-bottom: 40px;">Thank you for creating an account with Kant. To continue please confirm your email by clicking the button below:</div>
                <table class="mobile-text-center" bgcolor="#3FB58B" cellpadding="0" cellspacing="0" style="border-radius: 3px;">
                  <tr>
                    <th class="sans-serif">
                      <a href="http://example.com" style="border: 0 solid #3FB58B; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 400; padding: 15px 50px 15px 50px; text-decoration: none;">Confirm Email Address</a>
                    </th>
                  </tr>
                </table>
                <div style="color: #969AA1; font-size: 13px; margin-top: 40px;">Thanks, <br><strong>The Kant Team</strong></div>
              </th>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
                  ...
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                      <a href="http://example.com">
                        <img src="../../../images/footer/logo-footer.png" width="78" alt="Footer Logo" style="border: 0; width: 100%; max-width: 78px;">
                      </a>
                    </th>
                      ...
                      <table align="right" class="mobile-left" cellpadding="10" cellspacing="0">
                        <tr>
                          <td style="padding-left: 0;">
                            <a href="http://example.com" style="text-decoration: none;">
                              <img src="../../../images/icons/social/circle/twitter-circle.png" width="24" alt="Twitter" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td>
                            <a href="http://example.com" style="text-decoration: none;">
                              <img src="../../../images/icons/social/circle/facebook-circle.png" width="24" alt="Facebook" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td>
                            <a href="http://example.com" style="text-decoration: none;">
                              <img src="../../../images/icons/social/circle/pinterest-circle.png" width="24" alt="Pinterest" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td style="padding-right: 0;">
                            <a href="http://example.com" style="text-decoration: none;">
                              <img src="../../../images/icons/social/circle/googleplus-circle.png" width="24" alt="Google+" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                        </tr>
                      </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-6" width="200" style="padding-right: 10px; color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="font-size: 14px; font-weight: 700; margin-bottom: 15px;">Kant Headquarters</div>
                      <div class="sans-serif">
                        126-130 Crosby Street
                        <br> Soho New York City,
                        <br> NY 10012, U.S.
                      </div>
                    </th>
                    <th class="column mobile-6" width="420" style="padding-left: 10px; font-weight: 400; text-align: left;">
                      <div class="sans-serif" style="line-height: 100%; margin-bottom: 15px;">
                        <a href="http://example.com" style="color: #969AA1; text-decoration: none;">Have Questions?</a>
                      </div>
                      <div class="sans-serif" style="line-height: 100%; margin-bottom: 15px;">
                        <a href="http://example.com" style="color: #969AA1; text-decoration: none;">Online Version</a>
                      </div>
                      <div class="sans-serif" style="line-height: 100%;">
                        <a href="http://example.com" style="color: #969AA1; text-decoration: none;">Unsubscribe</a>
                      </div>
                    </th>
                  </tr>
                </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif">&copy; ThemeMountain. All Rights Reserved. <a href="http://example.com" style="color: #969AA1; text-decoration: none;">Terms &amp; Conditions</a> | <a href="http://example.com" style="color: #969AA1; text-decoration: none;">Unsubscribe</a></div>
                    </th>
                  </tr>
                  <tr>
