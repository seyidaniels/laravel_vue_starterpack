...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <address id = "contact">
            <div class="poic-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="/landing/assets/img/logo-white.png" class="img-fluid footer-img" alt="">
                            <p>
                                Birth the Idea. Fuel your Passion
                            </p>
                        </div>
                        <div class="col-md-1">
                            <p class="font-weight-bold" style="color: #121212">.........</p>
                            <p class="font-weight-bold" style="color:#121212">.........</p>
                        </div>
                        <div class="col-md-2">
                            <p class="font-weight-bold" style="color: white">Home</p>
                            <p class="font-weight-bold" style="color:white">Timeline</p>

                        </div>
                         <div class="col-md-2">
                            <p class="font-weight-bold">Rules</p>
                            <p class="font-weight-bold">Gallery</p>

                        </div>
                         <div class="col-md-1">
                            <p class="font-weight-bold">About</p>
                            <p class="font-weight-bold">FAQs</p>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="socials">
                                ...
                                <a class="social-icons" href="https://twitter.com/" target="_blank" rel="noopener">
                                    <span class="fa fa-twitter"></span>
                                </a>
                                <a class="social-icons" href="https://www.instagram.com/" target="_blank" rel="noopener">
                                    <span class="fa fa-instagram"></span>
                                </a>
                                <a class="social-icons" href="https://www.youtube.com" target="_blank" rel="noopener">
